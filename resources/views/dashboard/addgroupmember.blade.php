...
<div class="box box-warning marginl ">
            ...
            <table id="example3" class="table table-bordered table-striped ">
                ...
                <tr>
                  ...
                  <td class="text-center"><button id="{{$row['user_group_id']}}" class="btn btn-danger delete" type="button" name="remove" ><i class="fa fa-trash"></i></button>
