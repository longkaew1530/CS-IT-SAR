...
<div class="box box-warning marginl">
    ...
    @csrf
              ...
              <div class="form-group">
                  <div class="radio">
                    <label>
                      <input type="radio" name="result1" id="result1"  value="1" >
                      ไม่เป็นไปตามเกณฑ์
                    </label>
                  </div>
                  <div class="radio">
                    <label>
                      <input type="radio" name="result1" id="result2"  value="2" >
              ...
              <div class="form-group">
                  <div class="radio">
                    <label>
                      <input type="radio" name="result2" id="result3" value="1"  >
                      ไม่เป็นไปตามเกณฑ์
                    </label>
                  </div>
                  <div class="radio">
                    <label>
                      <input type="radio" name="result2" id="result4" value="2" >
                            เป็นไปตามเกณฑ์ ดังนี้
                    </label>
                  </div>
                </div> 
          ...
          <br><h4 class="box-title">3.คุณสมบัติของอาจารย์ประจำหลักสูตร(อาจารย์ประจำซึ่งมีหน้าที่สอนในสาขาวิชาของหลักสูตรที่เปิดสอน)</h4><br>
              ...
              <div class="form-group">
                  <div class="radio">
                    <label>
                      <input type="radio" name="result3" id="result5" value="1" >
                      ไม่เป็นไปตามเกณฑ์
                    </label>
                  </div>
                  <div class="radio">
                    <label>
                      <input type="radio" name="result3" id="result6" value="2" >
                            เป็นไปตามเกณฑ์ ดังนี้
                    </label>
                  </div>
                </div>
          ...
          <br><h4 class="box-title">4.คุณสมบัติของอาจารย์ผู้สอน</h4><br>
              ...
              <div class="form-group">
                  <div class="radio">
                    <label>
                      <input type="radio" name="result4" id="result7" value="1" >
                      ไม่เป็นไปตามเกณฑ์
                    </label>
                  </div>
                  <div class="radio">
                    <label>
                      <input type="radio" name="result4" id="result8" value="2" >
                            เป็นไปตามเกณฑ์ ดังนี้
                    </label>
                  </div>
                </div> 
          ...
          @if($checkedit!="")
              <div class="form-group">
                  <div class="radio">
                    <label>
                      <input type="radio" name="result5" id="result9" value="1">
                      ไม่เป็นไปตามเกณฑ์
                    </label>
                  </div>
                  <div class="radio">
                    <label>
                      <input type="radio" name="result5" id="result10" value="2">
                            เป็นไปตามเกณฑ์ ดังนี้
                    </label>
                  </div>
                </div>
