...
<div class="box box-warning ">
  <div class="box-header">
    ...
    <table class="table table-bordered">
                ...
                <td><input type="text" class="form-control" id="qtyrate" name="qtyrate" value="{{$row['qtyrate']}}" onchange="myScript()"/></td>
                <tr>
                </tr>
                ...
                <td><input type="text" class="form-control" id="resultscore" name="resultscore" value="{{$row['resultscore']}}" onchange="myScript1()"/></td>
                <tr>
                </tr>
                @endforeach
              </tbody></table>
