    ...
    @csrf
        ...
        <div class="col-md-12">
          ...
          <thead>
                ...
                <tbody>
          <?php $i=1 ?>
          @foreach($row->docindicator4_3 as $value)
                    <tr>  
                         <td >{{$i}}</td>
          ...
          <div id="body">
            ...
            <table class="table table-bordered text-center">
                ...
                <tr>
                  ...
                  <td rowspan="2"><input type="number" class="form-control text-center" name="target" min="0" max="5" value="{{$row['target']}}"></td>
                  @if($per1!=null)
                    <td ><input type="number" class="form-control text-center" name="performance1" min="0" max="5" value="{{$row['performance1']}}"></td></td>
                  @endif  
                  <td rowspan="2"><input type="number" class="form-control text-center" name="performance3" min="0" max="5" value="{{$row['performance3']}}"></td>
                  <td rowspan="2"><input type="number" class="form-control text-center" name="score" min="0" max="5" value="{{$row['score']}}"></td>
                </tr>
                <tr>
                @if($per1!=null)
                    <td ><input type="number" class="form-control text-center" name="performance2" min="0" max="5" value="{{$row['performance2']}}"></td></td>
                  @endif  
                </tr>
                <tr>
                @endforeach
