    ...
    <div class="row">
        ...
        <div class="col-md-12">
          <div id="body">
            ...
            <input type="text" class="form-control" id="anomaly" name="anomaly" placeholder="ความผิดปกติ" value="{{$row['anomaly']}}">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-12">
          <div id="body">
            ...
            <input type="text" class="form-control" id="tocheck" name="tocheck" placeholder="การตรวจสอบ" value="{{$row['tocheck']}}">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
          <div id="body">
            ...
            <input type="text" class="form-control" id="reason" name="reason" placeholder="เหตุผลที่ทำให้ผิดปกติ" value="{{$row['reason']}}">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-12">
          <div id="body">
            ...
            <input type="text" class="form-control" id="plan_update" name="plan_update" placeholder="มาตรการแก้ไข" value="{{$row['plan_update']}}">
            </div>
          </div>
        </div>
      </div>
  ...
  $(document).ready(function(e) {
    ...
    .then((willDelete) => {
      if (willDelete) {
        $.ajax({
        type: 'POST',
        url: "/updateacademic_performance",
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
