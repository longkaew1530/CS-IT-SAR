    ...
    //    dd($category_re);
       ...
       ->where('branch_id',session()->get('branch_id'))
        ...
        ->get();
            ...
            return view('downloadcategory/category6',compact('coursemanage','checkedit','assessmentsummary'
        ...
        foreach($getpermiss as $checkper){
            ...
            return view('downloadcategory/category7',compact('querystrength','checkedit','querydevelopment_proposal'
