...
class DownloadController extends Controller
{
    ...
    //    dd($category_re);
        ...
        return view('downloadcategory/category2',compact('pdca','name','id','getcourse','getcategorypdca','inc','checkedit','category_re','count','counteb_name','countposition1','countposition2','countposition3'
       ...
       $effec=category4_effectiveness::where('course_id',session()->get('usercourse'))
        ...
        $checkedit="";
            return view('downloadcategory/category5',compact('coursemanage','checkedit','pdca','name','id','getcourse','getcategorypdca','inc'));
        }
        else if($id==6){
            ...
            ->where('year_id',session()->get('year_id'))
            ->get();
            return view('downloadcategory/category6',compact('coursemanage','checkedit','assessmentsummary','assessmentsummary2',));
        }
        else if($id==7){
        ...
        ->where('year_id',session()->get('year_id'))
        ->get();
            return view('downloadcategory/category7',compact('querystrength','checkedit','querydevelopment_proposal','querynewstrength'));
        }
        else if($id==8){
        ...
        ->get();
        $checkedit="";
            return view('downloadcategory/category8',compact('querynewstrength','getnewstrength','checkedit','pdca','per1','getall','indicator','pdca2','per2','getall2','indicator2','data'));
        }
